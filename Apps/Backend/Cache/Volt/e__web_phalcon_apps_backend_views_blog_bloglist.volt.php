    ...
    <div class="row-fluid">
        <div class="span12 widget">
            <div class="widget-header">
                ...
                <a href="<?php echo $this->url->get('admin/blog/blogAdd'); ?>" class="btn"><i class="icol-add"></i> 添加博文</a>
            </div>
                ...
                <table id="demo-dtable-02" class="table table-striped">
                    ...
                    <?php foreach ($blogs as $blog) { ?>    
                        <tr>
                            ...
                            <td><?php echo $blog->guide; ?></td>
                            <td><?php echo $blog->blogcat->name; ?></td>
                            <td><?php echo $blog->ctime; ?></td>
                            <td><?php echo $blog->hits; ?></td>
                            <td class="action-col">
                                <span class="btn-group">
                                    <a href="{:U('user/access_config',array('role_id'=>$v['Id']))}" title="查看拥有权限" class="btn btn-small"><i class="icon-search"></i></a>
                                    <a href="/admin/blog/blogEdit?id=<?php echo $blog->id; ?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                    <a  data-id="<?php echo $blog->id; ?>" class="del-button btn btn-small"><i class="icon-trash"></i></a>
                                </span>
                            </td>
                        </tr>
                    <?php } ?>
