            ...
            <div class="widget-content form-container">
                <form id="validate-1" class="form-vertical" method="post">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="title" value="<?php echo $blog->title; ?>"  class="span12">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="input01" name="category" class="span12">
                                ...
                                <?php foreach ($catlist as $cat) { ?>
                                    <option value="<?php echo $cat['id']; ?>" <?php if ($blog->category_id == $cat['id']) { ?>selected="selected"<?php } ?> >
                                        <?php echo $cat['html']; ?><?php echo $cat['name']; ?>
                                    </option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="span12" name="guide" id="input05" rows="3"><?php echo $blog->guide; ?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                            ...
                            <div id="tdimgcover" style="display: inline-block">
                                <div class="showImg">
                                    <div id="discover" class="showImgC">
                                        <img style="height:160px" src="<?php echo $blog->cover; ?>"
                                    </div>
                                    <div id="btnimgcover">
                                        <input type="button" style="width: 133px;" class="btn btn-primary" id="coverBtn" value="上传图片" />
                                    </div>
                                    <input type="hidden" name="cover"  value="<?php echo $blog->cover; ?>" id="cover"  />
                                </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <!-- 加载编辑器的容器 -->
                            <script id="container" name="content" type="text/plain"><?php echo $blog->content; ?></script>
                            <!-- 实例化编辑器 -->
                            <script type="text/javascript">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="keywords" value="<?php echo $blog->keywords; ?>"  class="span12">
                        </div>
                    </div>
                              <div class="control-group">
                        <label class="control-label" for="input05">seo描述</label>
                        <div class="controls">
                            <textarea class="span12" name="description" id="input05" rows="3"><?php echo $blog->description; ?></textarea>
                        </div>
                    </div>
