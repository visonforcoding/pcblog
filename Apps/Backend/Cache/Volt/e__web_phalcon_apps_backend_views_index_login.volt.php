...
<html lang="zh"><head>
    ...
    <link rel="stylesheet" type="text/css" href="/admin/css/premium.css">
</head>
         ...
         <form action="" method="post">
               <input type="hidden" name="_csrf_token" value="" />
                <div class="form-group">
                    ...
                    <input type="text" id="username" class="form-control span12" name="_username" value="" required="required" />
                </div>
                <div class="form-group">
