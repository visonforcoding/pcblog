            ...
            <div class="widget-content form-container">
                <form id="validate-1" class="form-vertical" method="post">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="title" value="{{blog.title}}"  class="span12">
                        </div>
                    </div>
                    <div class="control-group">
...
{#                                <option value="0">顶级</option>#}
                                {% for cat in catlist %}
                                    <option value="{{cat['id']}}" {% if blog.category_id == cat['id']%}selected="selected"{% endif %} >
                                        {{cat['html']}}{{cat['name']}}
                                    </option>
                                {% endfor %}
                            </select>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="span12" name="guide" id="input05" rows="3">{{blog.guide}}</textarea>
                        </div>
                    </div>
                    <div class="control-group">
                            ...
                            <div id="tdimgcover" style="display: inline-block">
                                <div class="showImg">
                                    <div id="discover" class="showImgC">
                                        <img style="height:160px" src="{{blog.cover}}"
                                    </div>
                                    <div id="btnimgcover">
                                        <input type="button" style="width: 133px;" class="btn btn-primary" id="coverBtn" value="上传图片" />
                                    </div>
                                    <input type="hidden" name="cover"  value="{{blog.cover}}" id="cover"  />
                                </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="keywords" value="{{blog.keywords}}"  class="span12">
                        </div>
                    </div>
                              <div class="control-group">
                        <label class="control-label" for="input05">seo描述</label>
                        <div class="controls">
                            <textarea class="span12" name="description" id="input05" rows="3">{{blog.description}}</textarea>
                        </div>
                    </div>
